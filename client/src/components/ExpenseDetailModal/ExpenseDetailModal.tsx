...
// import usePutAndDeleteBill from '@hooks/usePutAndDeleteBill';
...
// const ExpenseDetailModal = ({billAction, isBottomSheetOpened, setIsBottomSheetOpened}: ExpenseDetailModalProps) => {
//   const {
//     inputPair,
//     handleInputChange,
//     // handleOnBlur,
...
//   } = usePutAndDeleteBill({title: billAction.name, price: String(billAction.price), index: 0}, validatePurchase, () =>
...
//   const actionMemberList = steps.filter(({actions}) =>
