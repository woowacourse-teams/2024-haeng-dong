...
export const stepListHandler = [
  http.get<any, StepListResponseBody, any, `${typeof MOCK_API_PREFIX}${typeof USER_API_PREFIX}/:eventId/actions`>(
    `${MOCK_API_PREFIX}${USER_API_PREFIX}/:eventId/actions`,
    () => {
  ...
  http.delete<{actionId: string}>(
    `${MOCK_API_PREFIX}${USER_API_PREFIX}/:eventId/member-actions/:actionId`,
    ({params}) => {
  ...
  http.post<
    any,
    PostMemberListRequestBody,
    any,
    `${typeof MOCK_API_PREFIX}${typeof USER_API_PREFIX}/:eventId/member-actions`
  >(`${MOCK_API_PREFIX}${USER_API_PREFIX}/:eventId/member-actions`, async ({request}) => {
  ...
  http.post<
    any,
    PostBillListRequestBody,
    any,
    `${typeof MOCK_API_PREFIX}${typeof USER_API_PREFIX}/:eventId/bill-actions`
  >(`${MOCK_API_PREFIX}${USER_API_PREFIX}/:eventId/bill-actions`, async ({request}) => {
